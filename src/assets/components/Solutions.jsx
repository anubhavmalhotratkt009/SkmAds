...
const aboutTypes = [
  ...
  },
  {
    ...
    desc: `SKMADS, our Performance-Based Advertising solutions are designed to help brands acquire new qualified leads and convert prospects into loyal customers.
...
const Solutions = () => {
  return (
    <>
      ...
      <div
        className="d-flex flex-row pt-5 gap-5"
                    ...
                    <div className="d-flex flex-wrap ca-initvalues-applied lqd-animations-done solutions-inner">
                      <div className="d-flex flex-wrap pb-200 module-content">
                        ...
                        <div className="ld-fancy-heading position-relative mb-3">
                          <h2 className="ld-fh-element position-relative lqd-highlight-custom lqd-highlight-custom-2 mt-0/25em mb-0/75em text-24 is-in-view lqd-unit-animation-done">
