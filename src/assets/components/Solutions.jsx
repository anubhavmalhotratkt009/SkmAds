...
const Solutions = () => {
  return (
    <div className="solutions-con col justify-content-center pt-5 pb-0">
      <div className="row justify-content-center p-0">
        <div className="col text-center">
          <h1 className="fw-bold services-header">Our Solutions</h1>
          <p className="text-muted fw-semibold services-inner-desc px-4">
              ...
              <>
                <div className="row" style={{ backgroundColor: "#fafafa" }}>
                  ...
                  <div className="col-lg-6 p-5">
                    ...
                    {service.desc.split("<br/>").map((a) => {
                      return <p className="mt-3 fs-6 text-muted">{a}</p>;
                    })}
                  </div>
                </div>
              </>
