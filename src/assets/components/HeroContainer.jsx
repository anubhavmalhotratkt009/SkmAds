                      ...
                      <div className="iconbox-icon-container d-inline-flex w-40 text-40 text-primary">
                        ...
                        >
                          ...
                          <path
                            ...
                            transform="translate(-1.289 -1.632)"
                            fillRule="evenodd"
                            opacity="0.3"
                          ></path>
                          <path
                            ...
                            transform="translate(-2.842 -10.23)"
                            fillRule="evenodd"
                          ></path>
                        </svg>
                      </div>
                      ...
                      <div className="iconbox-icon-container d-inline-flex w-40 text-40 text-primary">
                        ...
                        >
                          ...
                          <path
                            ...
                            transform="translate(7.23 6.417)"
                          ></path>
                          <path
                            ...
                            transform="translate(1.955 3.91)"
                          ></path>
                          <rect
                            width="31.38"
                            height="3.303"
                            transform="translate(8.423 30.447) rotate(-45)"
                            opacity="0.3"
                          ></rect>
                        </svg>
                      </div>
